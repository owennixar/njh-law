          ...
          <div className="grid items-end gap-12 lg:grid-cols-12">
            ...
            <FadeIn delay={0.1} className="lg:col-span-8">
              ...
              <div className="mt-6 flex flex-wrap items-center gap-4">
                <span className="inline-block rounded-md bg-white p-2"><img src="/images/Badges/tony/super-lawyer.avif" alt="Tony Jach – Texas Super Lawyer" className="h-[60px] w-auto object-contain lg:h-[75px]" /></span>
                <span className="inline-block rounded-md bg-white p-2"><img src="/images/Badges/tony/best-law-firms.avif" alt="Best Law Firms – Regional Tier 1" className="h-[60px] w-auto object-contain lg:h-[75px]" /></span>
                <span className="inline-block rounded-md bg-white p-2"><img src="/images/Badges/tony/martindale-hubbell.avif" alt="Martindale-Hubbell AV Preeminent" className="h-[60px] w-auto object-contain lg:h-[75px]" /></span>
              </div>
