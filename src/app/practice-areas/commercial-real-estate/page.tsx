...
export default function CommercialRealEstatePage() {
  return (
    <>
      ...
      <section className="bg-navy-950 py-28 lg:py-40">
        <div className="mx-auto max-w-7xl px-6">
          <FadeIn>
            ...
            <h1 className="mt-4 max-w-3xl font-heading text-3xl font-bold leading-tight tracking-tight text-white sm:text-4xl lg:text-5xl">
      ...
      {/* ============================================================ */}
      {/* DEAL TYPES + CLIENT TYPES — merged two-column section        */}
      {/* ============================================================ */}
      <section className="bg-white py-24 lg:py-32">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="mt-16 grid gap-16 lg:grid-cols-12">
            {/* LEFT — deal types as stacked items */}
            <div className="space-y-12 lg:col-span-7">
              {[
                {
                  title: "Acquisition and disposition",
                  body: "We draft and negotiate purchase and sale agreements, structure due diligence timelines, review title commitments and survey exceptions, and coordinate closings with title companies across Texas. On dispositions, we handle seller disclosures, negotiate representations and warranties, and structure 1031 exchanges under IRC \u00a71031 to defer capital gains.",
                },
                {
                  title: "Commercial development",
                  body: "Ground-up development requires legal coordination across zoning, entitlements, development agreements, tax abatements, and construction contracts. We work with developers on PID financing, TIF agreements with North Texas municipalities, and Chapter 380/381 economic development incentives under the Texas Local Government Code.",
                },
                {
                  title: "Construction contracts for real estate projects",
                  body: "Development and construction are inseparable. Our construction law practice works alongside our real estate team on owner-side GMP contracts, design-build agreements, AIA documents, lien waivers, and retainage management. Developers get integrated counsel instead of two firms that do not talk to each other.",
                  link: { href: "/practice-areas/construction-law", label: "construction law practice" },
                },
                {
                  title: "Commercial leasing \u2014 office, retail, industrial",
                  body: "Lease economics drive property value. We draft and negotiate leases across every major property type in DFW. That includes Class A office on the Dallas Parkway corridor, industrial distribution in Alliance, and single-tenant NNN retail. Key issues include CAM reconciliation, operating expense caps, TI allowances, co-tenancy clauses, and exclusive use restrictions. Texas commercial leases fall outside Property Code Chapter 92, so every protection must be written into the document.",
                },
                {
                  title: "Real estate financing",
                  body: "Loan documents require the same scrutiny as the purchase agreement. We represent borrowers in construction loan closings, permanent financing, mezzanine debt structuring, and loan modifications. Texas has specific requirements for deeds of trust, lien priority under Texas Property Code Chapter 53, and non-judicial foreclosure procedures under \u00a751.002.",
                },
                {
                  title: "Workouts and collateral enforcement",
                  body: "When a project underperforms, the lender relationship shifts from cooperative to adversarial. We represent borrowers and guarantors in loan workouts, forbearance negotiations, deed-in-lieu transactions, and receivership proceedings. When enforcement is unavoidable, we handle non-judicial foreclosures under Texas Property Code \u00a751.002 and deficiency actions in Texas state courts.",
                },
              ].map((item, i) => (
                <FadeIn key={item.title} delay={i * 0.05}>
                  ...
                  <p className="mt-3 text-sm leading-relaxed text-charcoal-600">
                    {item.link ? (
                      <>
                        <strong>Development and construction are inseparable.</strong>{" "}
                        Our{" "}
                        <Link
                          href={item.link.href}
                        ...
                        works alongside our real estate team on owner-side GMP
                        contracts, design-build agreements, AIA documents, lien
                        waivers, and retainage management. Developers get
                        integrated counsel instead of two firms that do not talk
                        to each other.
                      </>
                    ) : (
                      <>
                        <strong>{item.body.slice(0, item.body.indexOf(".") + 1)}</strong>
                        {item.body.slice(item.body.indexOf(".") + 1)}
                      </>
                    )}
                  </p>
                </FadeIn>
            ...
            {/* RIGHT — client types as sticky sidebar cards */}
                ...
                <div className="mt-6 space-y-4">
                  {[
                    ...
                    <FadeIn key={client.label} delay={i * 0.04}>
                      <div className="rounded border border-charcoal-200 bg-charcoal-50 px-5 py-4">
      ...
      {/* ============================================================ */}
      {/* OUR APPROACH — timeline style, scenario embedded             */}
      {/* ============================================================ */}
        ...
        <div className="mx-auto max-w-7xl px-6">
          <FadeIn>
            ...
            <p className="mt-4 max-w-2xl text-charcoal-400">
              ...
              manage every phase of the deal — from LOI through post-closing
              compliance. Not every deal needs the same level of attention.
              A $500K strip-center purchase requires different diligence than
              a $40M mixed-use development. We scale the work to the risk.
            </p>
          </FadeIn>
          ...
          <div className="mt-14 grid gap-16 lg:grid-cols-12">
            <div className="space-y-10 border-l-2 border-navy-600/30 pl-8 lg:col-span-7">
              {[
                {
                  step: "01",
                  title: "Deal structure and risk assessment",
                  desc: "Before the LOI is signed, we evaluate the deal structure \u2014 entity selection under the Texas Business Organizations Code, tax implications, liability exposure, and financing contingencies. The goal is to identify risks that are cheaper to address now than after closing.",
                },
                {
                  step: "02",
                  title: "Due diligence management",
                  desc: "We coordinate title review, survey analysis, environmental reports, zoning confirmation, lease audits, and estoppel certificate collection. Our real estate attorneys run due diligence as a structured checklist \u2014 not a passive document review. We flag issues that affect value, insurability, or lender requirements before they become closing obstacles.",
                },
                {
                  step: "03",
                  title: "Negotiation and closing",
                  desc: "We negotiate the final contract terms, resolve title objections, coordinate lender document execution, and manage the closing process. On development deals, this includes construction loan closings, contractor lien waivers, and recorded development agreements with the municipality.",
                },
                {
                  step: "04",
                  title: "Post-closing and ongoing counsel",
                  desc: "Closing is not the end. We handle tenant lease-up, property management agreements, CAM reconciliation disputes, and disposition planning. When a DFW office landlord discovers a tenant has been under-reporting sales for percentage rent, we audit the lease, quantify the shortfall, and negotiate recovery \u2014 often without filing suit.",
                },
              ].map((item, i) => (
            ...
            {/* Scenario + GEO block — right column */}
            <div className="lg:col-span-5">
              <FadeIn delay={0.15}>
                <div className="rounded-lg border border-navy-800 bg-navy-900 p-8">
                  ...
                  <p className="mt-3 font-heading text-lg font-bold leading-snug text-white">
                    When a title search reveals an unresolved easement on a $9M
                    retail acquisition in North Texas
                  </p>
                  <p className="mt-4 text-sm leading-relaxed text-charcoal-300">
                    Three weeks before closing, the title commitment shows a
                    utility easement that crosses the planned building pad. The
                    seller says it was never enforced. The lender says it is an
                    unacceptable exception.
                  </p>
                  <p className="mt-3 text-sm leading-relaxed text-charcoal-300">
                    We trace the easement to a 1987 deed, confirm the utility
                    company still holds rights, and negotiate a partial release
                    and relocation agreement. The buyer closes on schedule. The
                    lender funds. The seller avoids a price reduction. That is
                    what deal counsel does — remove the obstacle without killing
                    the deal.
                  </p>
                </div>
              </FadeIn>
              ...
              <FadeIn delay={0.25}>
                <div className="mt-6 rounded-lg border border-navy-600/20 bg-navy-900 p-6">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-charcoal-400">
                    Commercial real estate disputes in Dallas are typically
                    resolved through direct negotiation, formal mediation, or
                    litigation in Dallas County district courts. Common claims
                    include breach of purchase agreement, title defects, lease
                    defaults, and partnership disagreements. Texas Property Code
                    and Texas Business Organizations Code govern most
      ...
      {/* ============================================================ */}
      {/* FAQ — numbered list, single column                           */}
      {/* ============================================================ */}
      <section className="bg-charcoal-50 py-24 lg:py-32">
        <div className="mx-auto max-w-7xl px-6">
          <FadeIn>
            <h2 className="font-heading text-3xl font-bold tracking-tight text-navy-900 sm:text-4xl">
              Frequently asked questions about commercial real estate in Texas
            </h2>
          </FadeIn>

          <div className="mt-14 space-y-0 divide-y divide-charcoal-200">
            {faqData.map((item, i) => (
              <FadeIn key={i} delay={i * 0.05}>
                <div className="grid gap-6 py-8 lg:grid-cols-12">
                  <p className="font-heading text-4xl font-bold text-charcoal-200 lg:col-span-1">
          ...
          <div className="mt-12 flex flex-col gap-4 md:flex-row">
            <FadeIn className="flex-1">
              ...
              >
                ...
                <p className="mt-3 text-sm leading-relaxed text-charcoal-600">
                  Every development project creates construction risk. Our{" "}
                  <span className="text-gold-600">
                    Dallas construction attorneys
                  </span>{" "}
                  handle contract disputes, mechanic&apos;s lien claims, and
                  project litigation for owners and contractors across Texas.
                </p>
              </Link>
            </FadeIn>
            ...
            <FadeIn delay={0.1} className="flex-1">
              ...
              >
                ...
                <p className="mt-3 text-sm leading-relaxed text-charcoal-600">
                  Real estate deals require entity formation, joint venture
                  agreements, and investor documentation structured under the{" "}
                  <span className="text-gold-600">
            ...
            <FadeIn delay={0.2} className="flex-1">
              ...
              >
                ...
                <p className="mt-3 text-sm leading-relaxed text-charcoal-600">
                  Partnership disputes, fiduciary claims, and investor
                  disagreements on real estate ventures that require courtroom
                  resolution across the DFW metroplex.
                </p>
              </Link>
            </FadeIn>
          </div>
          ...
          <FadeIn>
            <div className="flex flex-col items-start gap-10 lg:flex-row lg:items-center lg:justify-between">
              <div className="max-w-xl">
                <h2 className="font-heading text-3xl font-bold tracking-tight text-white sm:text-4xl">
                  Discuss your real estate transaction with a Dallas commercial
                  real estate attorney
                </h2>
                <p className="mt-4 text-charcoal-300">
                  Tell us about your deal. We respond within one business day.
                  No obligation.
                </p>
              </div>
