...
export const metadata: Metadata = {
  title: "How to File a Mechanic\u2019s Lien in Texas | Nixon Jach Hubbard | Dallas Construction Attorneys",
  description:
    "Step-by-step guide to filing a mechanic\u2019s lien in Texas under Property Code Chapter 53. Deadlines, notice requirements & enforcement by a Dallas construction attorney.",
  openGraph: {
    type: "article",
